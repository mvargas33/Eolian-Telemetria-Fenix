...
bool check_mppt=true;   //Check receive de ET para MPPTs
bool xbee=false;      // Enviar o no por wifi, función Send_Xbee_Data()
...
void UpdateMPPTin(){
  mppt_in = (MPPT1[1]*MPPT1[2])+(MPPT2[1]*MPPT2[2])+(MPPT3[1]*MPPT3[2])+(MPPT4[1]*MPPT4[2]); // In Whatts
}
/*///////////////////////// UPDATE VELOCIDAD //////////////////////////*/
...
/*
    Serial.print("MPPT2 Char at 0 = ");Serial.println(mppt_data.mppt2.charAt(0));
    String Uin_1 =  String((mppt_data.mppt1).charAt(0))+String((mppt_data.mppt1).charAt(1))+String((mppt_data.mppt1).charAt(2))+String((mppt_data.mppt1).charAt(3))+String((mppt_data.mppt1).charAt(4));
    String Iin_1 =  String((mppt_data.mppt1).charAt(5))+String((mppt_data.mppt1).charAt(6))+String((mppt_data.mppt1).charAt(7))+String((mppt_data.mppt1).charAt(8));
    String Uout_1 = String((mppt_data.mppt1).charAt(9))+String((mppt_data.mppt1).charAt(10))+String((mppt_data.mppt1).charAt(11))+String((mppt_data.mppt1).charAt(12))+String((mppt_data.mppt1).charAt(13));
    String temp_1 = String((mppt_data.mppt1).charAt(14))+String((mppt_data.mppt1).charAt(15));
    String uout_umax_1 =  String((mppt_data.mppt1).charAt(16));
    String t_cooler_1 =   String((mppt_data.mppt1).charAt(17));
    String bateria_1 =    String((mppt_data.mppt1).charAt(18));
    String under_volt_1 = String((mppt_data.mppt1).charAt(19));
    
    MPPT1[0]= Uin_1.toInt();
    MPPT1[1]= Iin_1.toInt();
    MPPT1[2]= Uout_1.toInt();
    MPPT1[3]= temp_1.toInt();
    MPPT1[4]= uout_umax_1.toInt();
    MPPT1[5]= t_cooler_1.toInt();
    MPPT1[6]= bateria_1.toInt();
    MPPT1[7]= under_volt_1.toInt();
  
    String Uin_2 =  String((mppt_data.mppt2).charAt(0))+String((mppt_data.mppt2).charAt(1))+String((mppt_data.mppt2).charAt(2))+String((mppt_data.mppt2).charAt(3))+String((mppt_data.mppt2).charAt(4));
    String Iin_2 =  String((mppt_data.mppt2).charAt(5))+String((mppt_data.mppt2).charAt(6))+String((mppt_data.mppt2).charAt(7))+String((mppt_data.mppt2).charAt(8));
    String Uout_2 = String((mppt_data.mppt2).charAt(9))+String((mppt_data.mppt2).charAt(10))+String((mppt_data.mppt2).charAt(11))+String((mppt_data.mppt2).charAt(12))+String((mppt_data.mppt2).charAt(13));
    String temp_2 = String((mppt_data.mppt2).charAt(14))+String((mppt_data.mppt2).charAt(15));
    String uout_umax_2 =  String((mppt_data.mppt2).charAt(16));
    String t_cooler_2 =   String((mppt_data.mppt2).charAt(17));
    String bateria_2 =    String((mppt_data.mppt2).charAt(18));
    String under_volt_2 = String((mppt_data.mppt2).charAt(19));
    
    MPPT2[0]= Uin_2.toInt();
    MPPT2[1]= Iin_2.toInt();
    MPPT2[2]= Uout_2.toInt();
    MPPT2[3]= temp_2.toInt();
    MPPT2[4]= uout_umax_2.toInt();
    MPPT2[5]= t_cooler_2.toInt();
    MPPT2[6]= bateria_2.toInt();
    MPPT2[7]= under_volt_2.toInt();
    Serial.print("MPPT2 UIN = ");Serial.println(MPPT2[0]);
  */
  }
