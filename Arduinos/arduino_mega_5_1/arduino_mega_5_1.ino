...
bool tablet=false;    // Enviar o no por Serial0 la infromación a la tablet, función Send_tablet_Data()
bool pc=true;
/*//////////////////// VARIABLES TABLET ////////////////////*/
...
void Printdata_10(int entero){
  if (entero == 0){
    ...
    Serial.print(entero/10);
  }
  else if ((100<=entero)&&(entero<1000)){
    Serial.print(entero/100);
  }
  else if ((1000<=entero)&&(entero<10000)){
    Serial.print(entero/1000);
  }
  else if ((10000<=entero)&&(entero<100000)){
    Serial.print(entero/10000);
  }
}//Print de 2 dígitos
void Printdata_20(int entero){
  if (entero == 0){
    Serial.print("00");
  }
  else if ((0<entero)&&(entero<10)){
...
//Print de 5 dígitos
void Printdata_50(int entero){
  if (entero == 0){
    Serial.print("00000");
  }
  else if ((0<entero)&&(entero<10)){
    Serial.print("0000");Serial.print(entero);
  }
  else if ((10<=entero)&&(entero<100)){
    Serial.print("000");Serial.print(entero);
  }
...
void PrintdataUnsigned_10(unsigned int entero){
  if (entero == 0){
    Serial.print("0");
  }
  else if ((0<entero)&&(entero<10)){
...
void PrintdataUnsigned_20(unsigned int entero){
  if (entero == 0){
    Serial.print("00");
  }
  else if ((0<entero)&&(entero<10)){
...
void PrintdataUnsignedVolt0(unsigned int entero){
  if (entero == 0){
    Serial.print("00000");
  }
  else if ((0<entero)&&(entero<10)){
...
void PrintdataUnsignedVolt_60(unsigned int entero){
  if (entero == 0){
    Serial.print("000000");
  }
  else if ((0<entero)&&(entero<10)){
    Serial.print("00000");Serial.print(entero);
  }
  else if ((10<=entero)&&(entero<100)){
    Serial.print("0000");Serial.print(entero);
  }
...
void Send_Xbee_all0(){
  if(aux_data0==0){
    ...
    Printdata_30(velocidad);     // SPEED
    Printdata_30(BMS[1]);        // CURRENT
    delay(delay_40);
    //Kelly DER
    Serial.print(char(0x41));
    Printdata_20(KELLY_DER[0]);  // IA
    Printdata_20(KELLY_DER[1]);  // IB
    Printdata_20(KELLY_DER[2]);  // IC
    delay(delay_40);
    Serial.print(char(0x42));
    Printdata_20(KELLY_DER[3]);  // VA
    Printdata_20(KELLY_DER[4]);  // VB
    Printdata_20(KELLY_DER[5]);  // VC
    delay(delay_40);
    Serial.print(char(0x43));
    Printdata_40(KELLY_DER[6]);  // RPM
    Printdata_20(KELLY_DER[8]);  // PWM
    delay(delay_40);
    Serial.print(char(0x44));
    Printdata_40(KELLY_DER[7]);  // ERROR CODE
    Printdata_20(KELLY_DER[11]); // TEMP KELLY
    delay(delay_40);
    Serial.print(char(0x45));
    Printdata_10(KELLY_DER[9]);  // EMR
    Printdata_30(KELLY_DER[10]); // TEMP MOTOR
    Printdata_10(KELLY_DER[12]); // THROTTLE
    Printdata_10(KELLY_DER[13]); // REVERSE
    delay(delay_40);
    //Kelly IZ
    Serial.print(char(0x46));
    Printdata_20(KELLY_IZQ[0]);  // IA
    Printdata_20(KELLY_IZQ[1]);  // IB
    Printdata_20(KELLY_IZQ[2]);  // IC
    delay(delay_40);
    Serial.print(char(0x47));
    Printdata_20(KELLY_IZQ[3]);  // VA
    Printdata_20(KELLY_IZQ[4]);  // VB
    Printdata_20(KELLY_IZQ[5]);  // VC
    delay(delay_40);
    Serial.print(char(0x48));
    Printdata_40(KELLY_IZQ[6]);  // RPM
    Printdata_20(KELLY_IZQ[8]);  // PWM
    delay(delay_40);
    Serial.print(char(0x49));
    Printdata_40(KELLY_IZQ[7]);  // ERROR CODE
    Printdata_20(KELLY_IZQ[11]); // TEMP KELLY
    delay(delay_40);
    Serial.print(char(0x4a));
    Printdata_10(KELLY_IZQ[9]);  // EMR
    Printdata_30(KELLY_IZQ[10]); // TEMP MOTOR
    Printdata_10(KELLY_IZQ[12]); // THROTTLE
    Printdata_10(KELLY_IZQ[13]); // REVERSE
    delay(delay_40);
    aux_data0=1;
  }else if(aux_data0==1){
    //Speed-Current
    ...
    delay(delay_40);
    //BMS
    Serial.print(char(0x4b));
    Printdata_30(BMS[1]);        // CURRENT
    Printdata_30(BMS[2]);        // VOLTAGE
    delay(delay_40);
    Serial.print(char(0x4c));
    Printdata_30(BMS[0]);        // SOC
    Printdata_30(BMS[3]);        // OPEN VOLTAGE
    delay(delay_40);
    Serial.print(char(0x4d));
    Printdata_20(BMS[4]);        // ABSOLUTE CURRENT
    Printdata_20(BMS[7]);        // MAX TEMP
    Printdata_20(BMS[8]);        // MAX TEMP ID
    delay(delay_40);
    Serial.print(char(0x4e));
    PrintdataUnsignedVolt_60(MAX_VOLT);        // MAX VOLTAGE
    delay(delay_40);
    Serial.print(char(0x4f));
    PrintdataUnsignedVolt_60(MIN_VOLT);        // MIN VOLTAGE
    delay(delay_40);
    Serial.print(char(0x50));
    Printdata_20(BMS[9]);        // MIN TEMP
    Printdata_20(BMS[10]);       // MIN TEMP ID
    Printdata_20(BMS[11]);       // AVERAGE TEMP
    delay(delay_40);
    Serial.print(char(0x51));
    Printdata_20(BMS[12]);       // INTERNAL TEMP
    Printdata_20(BMS[13]);       // MAX VOLTAGE ID
    Printdata_20(BMS[14]);       // MIN VOLTAGE ID
    delay(delay_40);
    //BMS TEMP
    Serial.print(char(0x52));
    Printdata_20(BMS_TEMP[0]);
    Printdata_20(BMS_TEMP[1]);
    Printdata_20(BMS_TEMP[2]);
    delay(delay_40);
    Serial.print(char(0x53));
    Printdata_20(BMS_TEMP[3]);
    Printdata_20(BMS_TEMP[4]);
    Printdata_20(BMS_TEMP[5]);
    delay(delay_40);
    Serial.print(char(0x54));
    Printdata_20(BMS_TEMP[6]);
    Printdata_20(BMS_TEMP[7]);
    Printdata_20(BMS_TEMP[8]);
    delay(delay_40);
    aux_data0=2;
  }else if(aux_data0==2){
    //Speed-Current
    ...
    Printdata_20(BMS_TEMP[9]);
    Printdata_20(BMS_TEMP[10]);
    Printdata_20(BMS_TEMP[11]);
    delay(delay_40);
    Serial.print(char(0x56));
    Printdata_20(BMS_TEMP[12]);
    Printdata_20(BMS_TEMP[13]);
    Printdata_20(BMS_TEMP[14]);
    delay(delay_40);
    Serial.print(char(0x57));
    Printdata_20(BMS_TEMP[15]);
    Printdata_20(BMS_TEMP[16]);
    Printdata_20(BMS_TEMP[17]);
    delay(delay_40);
    Serial.print(char(0x58));
    Printdata_20(BMS_TEMP[18]);
    Printdata_20(BMS_TEMP[19]);
    Printdata_20(BMS_TEMP[20]);
    delay(delay_40);
    Serial.print(char(0x59));
    Printdata_20(BMS_TEMP[21]);
    Printdata_20(BMS_TEMP[22]);
    Printdata_20(BMS_TEMP[23]);
    delay(delay_40);
    Serial.print(char(0x5a));
    Printdata_20(BMS_TEMP[24]);
    Printdata_20(BMS_TEMP[25]);
    Printdata_20(BMS_TEMP[26]);
    delay(delay_40);
    Serial.print(char(0x61));
    Printdata_20(BMS_TEMP[27]);
    Printdata_20(BMS_TEMP[28]);
    Printdata_20(BMS_TEMP[29]);
    delay(delay_40);
    Serial.print(char(0x62));
    Printdata_20(BMS_TEMP[30]);
    Printdata_20(BMS_TEMP[31]);
    Printdata_20(BMS_TEMP[32]);
    delay(delay_40);
    Serial.print(char(0x63));
    Printdata_20(BMS_TEMP[33]);
    Printdata_20(BMS_TEMP[34]);
    Printdata_20(BMS_TEMP[35]);
    delay(delay_40);
    Serial.print(char(0x64));
    Printdata_20(BMS_TEMP[36]);
    Printdata_20(BMS_TEMP[37]);
    Printdata_20(BMS_TEMP[38]);
    delay(delay_40);
    aux_data0=3;
  }else if(aux_data0==3){
    //Speed-Current
    ...
    Printdata_20(BMS_TEMP[39]);
    Printdata_20(BMS_TEMP[40]);
    Printdata_20(BMS_TEMP[41]);
    delay(delay_40);
    Serial.print(char(0x66));
    Printdata_20(BMS_TEMP[42]);
    Printdata_20(BMS_TEMP[43]);
    Printdata_20(BMS_TEMP[44]);
    delay(delay_40);
    Serial.print(char(0x67));
    Printdata_20(BMS_TEMP[45]);
    Printdata_20(BMS_TEMP[46]);
    Printdata_20(BMS_TEMP[47]);
    delay(delay_40);
    Serial.print(char(0x68));
    Printdata_20(BMS_TEMP[48]);
    Printdata_20(BMS_TEMP[49]);
    Printdata_20(BMS_TEMP[50]);
    delay(delay_40);
    Serial.print(char(0x69));
    Printdata_20(BMS_TEMP[51]);
    Printdata_20(BMS_TEMP[52]);
    Printdata_20(BMS_TEMP[53]);
    delay(delay_40);
    Serial.print(char(0x6a));
    Printdata_20(BMS_TEMP[54]);
    Printdata_20(BMS_TEMP[55]);
    Printdata_20(BMS_TEMP[56]);
    delay(delay_40);
    Serial.print(char(0x6b));
    Printdata_20(BMS_TEMP[57]);
    Printdata_20(BMS_TEMP[58]);
    Printdata_20(BMS_TEMP[59]);
    delay(delay_40);
    //BMS VOLT
    Serial.print(char(0x40)); //@A
    Serial.print(char(0x41));
    PrintdataUnsignedVolt0(BMS_VOLT[0]);
    delay(delay_40);
    Serial.print(char(0x40)); //@B
    Serial.print(char(0x42));
    PrintdataUnsignedVolt0(BMS_VOLT[1]);
    delay(delay_40);
    Serial.print(char(0x40)); //@C
    Serial.print(char(0x43));
    PrintdataUnsignedVolt0(BMS_VOLT[2]);
    delay(delay_40);
    aux_data0=4;
  }else if(aux_data0==4){
    //Speed-Current
    ...
    Printdata_30(BMS[1]);        // CURRENT
    delay(delay_40);
    Serial.print(char(0x40)); //@D
    Serial.print(char(0x44));
    PrintdataUnsignedVolt0(BMS_VOLT[3]);
    delay(delay_40);
    Serial.print(char(0x40)); //@E
    Serial.print(char(0x45));
    PrintdataUnsignedVolt0(BMS_VOLT[4]);
    delay(delay_40);
    Serial.print(char(0x40)); //@F
    Serial.print(char(0x46));
    PrintdataUnsignedVolt0(BMS_VOLT[5]);
    delay(delay_40);
    Serial.print(char(0x40)); //@G
    Serial.print(char(0x47));
    PrintdataUnsignedVolt0(BMS_VOLT[6]);
    delay(delay_40);
    Serial.print(char(0x40)); //@H
    Serial.print(char(0x48));
    PrintdataUnsignedVolt0(BMS_VOLT[7]);
    delay(delay_40);
    Serial.print(char(0x40)); //@I
    Serial.print(char(0x49));
    PrintdataUnsignedVolt0(BMS_VOLT[8]);
    delay(delay_40);
    Serial.print(char(0x40)); //@J //10
    Serial.print(char(0x4a));
    PrintdataUnsignedVolt0(BMS_VOLT[9]);
    delay(delay_40);
    Serial.print(char(0x40)); //@K 
    Serial.print(char(0x4b));
    PrintdataUnsignedVolt0(BMS_VOLT[10]);
    delay(delay_40);
    Serial.print(char(0x40)); //@L
    Serial.print(char(0x4c));
    PrintdataUnsignedVolt0(BMS_VOLT[11]);
    delay(delay_40);
    Serial.print(char(0x40)); //@M
    Serial.print(char(0x4d));
    PrintdataUnsignedVolt0(BMS_VOLT[12]);
    delay(delay_40);
    aux_data0=5;
  }else if(aux_data0==5){
    //Speed-Current
    ...
    Printdata_30(BMS[1]);        // CURRENT
    delay(delay_40);
    Serial.print(char(0x40)); //@N
    Serial.print(char(0x4e));
    PrintdataUnsignedVolt0(BMS_VOLT[13]);
    delay(delay_40);
    Serial.print(char(0x40)); //@O
    Serial.print(char(0x4f));
    PrintdataUnsignedVolt0(BMS_VOLT[14]);
    delay(delay_40);
    Serial.print(char(0x40)); //@P
    Serial.print(char(0x50));
    PrintdataUnsignedVolt0(BMS_VOLT[15]);
    delay(delay_40);
    Serial.print(char(0x40)); //@Q
    Serial.print(char(0x51));
    PrintdataUnsignedVolt0(BMS_VOLT[16]);
    delay(delay_40);
    Serial.print(char(0x40)); //@R
    Serial.print(char(0x52));
    PrintdataUnsignedVolt0(BMS_VOLT[17]);
    delay(delay_40);
    Serial.print(char(0x40)); //@S
    Serial.print(char(0x53));
    PrintdataUnsignedVolt0(BMS_VOLT[18]);
    delay(delay_40);
    Serial.print(char(0x40)); //@T  //20
    Serial.print(char(0x54));
    PrintdataUnsignedVolt0(BMS_VOLT[19]);
    delay(delay_40);
    Serial.print(char(0x40)); //@U
    Serial.print(char(0x55));
    PrintdataUnsignedVolt0(BMS_VOLT[20]);
    delay(delay_40);
    Serial.print(char(0x40)); //@V
    Serial.print(char(0x56));
    PrintdataUnsignedVolt0(BMS_VOLT[21]);
    delay(delay_40);
    Serial.print(char(0x40)); //@W
    Serial.print(char(0x57));
    PrintdataUnsignedVolt0(BMS_VOLT[22]);
    delay(delay_40);
    aux_data0=6;
  }else if(aux_data0==6){
    //Speed-Current
    ...
    Printdata_30(BMS[1]);        // CURRENT
    delay(delay_40);
    Serial.print(char(0x40)); //@X
    Serial.print(char(0x58));
    PrintdataUnsignedVolt0(BMS_VOLT[23]);
    delay(delay_40);
    Serial.print(char(0x40)); //@Y
    Serial.print(char(0x59));
    PrintdataUnsignedVolt0(BMS_VOLT[24]);
    delay(delay_40);
    Serial.print(char(0x40)); //@Z
    Serial.print(char(0x5a));
    PrintdataUnsignedVolt0(BMS_VOLT[25]);
    delay(delay_40);
    Serial.print(char(0x40)); //@a
    Serial.print(char(0x61));
    PrintdataUnsignedVolt0(BMS_VOLT[26]);
    delay(delay_40);
    Serial.print(char(0x40)); //@b  //28
    Serial.print(char(0x62));
    PrintdataUnsignedVolt0(BMS_VOLT[27]);
    delay(delay_40);
    Serial.print(char(0x6d)); //m
    PrintdataUnsignedVolt_60(MPPT1[0]);  // Uin
    delay(delay_40);
    Serial.print(char(0x6e)); //n
    PrintdataUnsignedVolt_60(MPPT1[1]);  // Iin
    delay(delay_40);
    Serial.print(char(0x6f)); //o  
    PrintdataUnsignedVolt_60(MPPT1[2]);  // Uout
    delay(delay_40);
    Serial.print(char(0x70)); //p
    PrintdataUnsigned_10(MPPT1[3]);      // BVLR  = 
    PrintdataUnsigned_10(MPPT1[4]);      // OVT   = Over voltage
    PrintdataUnsigned_10(MPPT1[5]);      // NOC   = 
    PrintdataUnsigned_10(MPPT1[6]);      // UNDV  = Under voltage
    PrintdataUnsigned_20(MPPT1[7]);      // TEMP
    delay(delay_40);
    Serial.print(char(0x71));  //q
    PrintdataUnsignedVolt_60(MPPT2[0]);  // Uin
    delay(delay_40);
    aux_data0=7;
  }else if(aux_data0==7){
    //Speed-Current
    ...
    Printdata_30(BMS[1]);        // CURRENT
    delay(delay_40);
    Serial.print(char(0x72));  //r
    PrintdataUnsignedVolt_60(MPPT2[1]);  // Iin
    delay(delay_40);
    Serial.print(char(0x73));  //s
    PrintdataUnsignedVolt_60(MPPT2[2]);  // Uout
    delay(delay_40);
    Serial.print(char(0x74));  //t
    PrintdataUnsigned_10(MPPT2[3]);      // BVLR  = 
    PrintdataUnsigned_10(MPPT2[4]);      // OVT   = Over voltage
    PrintdataUnsigned_10(MPPT2[5]);      // NOC   = 
    PrintdataUnsigned_10(MPPT2[6]);      // UNDV  = Under voltage
    PrintdataUnsigned_20(MPPT2[7]);      // TEMP
    delay(delay_40);
    Serial.print(char(0x75));  //u
    PrintdataUnsignedVolt_60(MPPT3[0]);  // Uin
    delay(delay_40);
    Serial.print(char(0x76));  //v
    PrintdataUnsignedVolt_60(MPPT3[1]);  // Iin
    delay(delay_40);
    Serial.print(char(0x77));  //w
    PrintdataUnsignedVolt_60(MPPT3[2]);  // Uout
    delay(delay_40);
    Serial.print(char(0x78));  //x
    PrintdataUnsigned_10(MPPT3[3]);      // BVLR  = 
    PrintdataUnsigned_10(MPPT3[4]);      // OVT   = Over voltage
    PrintdataUnsigned_10(MPPT3[5]);      // NOC   = 
    PrintdataUnsigned_10(MPPT3[6]);      // UNDV  = Under voltage
    PrintdataUnsigned_20(MPPT3[7]);      // TEMP
    delay(delay_40);
    Serial.print(char(0x79));  //y
    PrintdataUnsignedVolt_60(MPPT4[0]);  // Uin
    delay(delay_40);
    Serial.print(char(0x7a));  //z
    PrintdataUnsignedVolt_60(MPPT4[1]);  // Iin
    delay(delay_40);
    Serial.print(char(0x7b));  //{
    PrintdataUnsignedVolt_60(MPPT4[2]);  // Uout
    delay(delay_40);
    Serial.print(char(0x7d));  //}
    PrintdataUnsigned_10(MPPT4[3]);      // BVLR  = 
    PrintdataUnsigned_10(MPPT4[4]);      // OVT   = Over voltage
    PrintdataUnsigned_10(MPPT4[5]);      // NOC   = 
    PrintdataUnsigned_10(MPPT4[6]);      // UNDV  = Under voltage
    PrintdataUnsigned_20(MPPT4[7]);      // TEMP
    delay(delay_40);
    aux_data0=0;
  }
...
/*//////////////////// LCD ////////////////////*/
void mostrarVelocidad(int vel, int consumo){
  lcd.setCursor(0, 0);
...
void setup()
{
  Serial.begin(9600);                //Tablet 115200
...
/*/////////////////////// PANTALLA LCD ///////////////////////*/
consumo=(BMS[1]*BMS[2])/100;
mostrarVelocidad(velocidad,consumo);
/*////////////////////// RECEIVE MPPTS //////////////////////*/
